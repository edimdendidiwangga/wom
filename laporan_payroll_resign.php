...
header("Content-Disposition: attachment; filename=Data Gaji Karyawan Resign Cab ".$name_cabang.".xls");
?>
...
<table id="example1" class="table table-striped table-bordered table-hover">
										   ...
										   where data_karyawan.status = '2' && data_karyawan.id_bu=".$_SESSION['id_bu']." && (karyawan.update_active BETWEEN '$from' AND '$to') 
