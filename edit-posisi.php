												...
												<div class="row">
												   <?php 
													...
													$query = mysql_query("
												        SELECT *
												        FROM posisi 
												        where posisi.id_posisi='$id'");
													
													$data = mysql_fetch_array($query);
													
													?>
													<form action="update_posisi.php" method="post" class="form-horizontal" role="
													form">
													<input type="hidden" name="id_posisi" value="<?php echo $id; ?>">
													
													<div class="form-group">
													   <label class="control-label col-md-3">Nama Posisi<span class="required">*</span></label>
													   <div class="col-md-4">
														  <input type="text" class="form-control" name="posisi" value="<?php echo $data['nama_posisi']; ?>">
